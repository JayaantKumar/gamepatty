...
// CHANGED: use the ghost hook
import useGhostProjectBySlug from '../hooks/useGhostProjectBySlug';
import { FaApple, FaGooglePlay, FaChevronLeft } from 'react-icons/fa6'; 
import steamLogo from "../assets/steam.png";
import SmartImage from '../components/SmartImage';

function GhostProjectDetailPage() {
  const { slug } = useParams();
  const { project, loading, error } = useGhostProjectBySlug(slug);
...
export default GhostProjectDetailPage;
